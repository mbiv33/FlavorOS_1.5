...
This document rewrites the old `05-call-surface.md` into the FlavorOS 1.5 MVP structured interaction model. It intentionally removes live-call-first, voice-first, transcript-first, and right-rail-takeover assumptions from MVP canon.
