...
This document replaces the old `06-right-rail.md` for the MVP. It defines reusable command-and-control components instead of a persistent chat/right-rail interface.
