...
This document normalizes old cron, runtime, deployment, provider, and storage intake into a FlavorOS 1.5 workflow/runtime candidate.

## Source Material

- `_migration/decisions.md`
- `_migration/intake/old_workflows/cron/schedules.yaml`
- `_migration/intake/old_workflows/config/normalization/`
- `_migration/intake/old_docs/architecture/FLAVOROS_STORAGE_AND_DATA_FLOW.md`
- `_migration/intake/old_runtime/docker-compose.yml`
- `_migration/intake/old_runtime/DEPLOYMENT.md`
- `_migration/intake/old_runtime/infra/composio.yaml`
