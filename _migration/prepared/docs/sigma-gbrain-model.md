# SIGMA And GBrain Model

Status: prepared migration candidate.

This document normalizes old SIGMA/Obsidian/Vault material into the FlavorOS 1.5 decision that GBrain is the memory, persistent state, and SIGMA layer. Obsidian is not the permanent source of truth.
...
- `_migration/intake/old_sigma/scripts/sigma/README.md`
- `_migration/intake/old_sigma/vault/05-SIGMA/_templates/`
