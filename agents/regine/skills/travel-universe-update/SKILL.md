...
description: >-
  Scooter — Universe-update protocol. Folds a debriefed trip's learnings into
...
# Scooter | Travel Universe Update
...
- **travel-debrief** (Scooter) — produces the `learnings` block this skill consumes
- **chief-of-staff** (Khadijah) — surfaces the close in the morning brief
- **travel-planning** (Scooter, future trips) — reads the long-term SIGMAs this skill maintains
