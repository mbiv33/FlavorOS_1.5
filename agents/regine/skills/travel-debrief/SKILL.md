...
name: travel-debrief
description: >-
  Scooter — Debrief protocol. Owns the return→debrief phase transition. T+1
...
- **travel-return** (Scooter) — preceding phase, leaves the open-items list this skill consumes
- **travel-universe-update** (Scooter) — consumes the learnings block this skill populates
- **ripple-observation** (Scooter)
