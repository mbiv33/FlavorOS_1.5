...
def upgrade() -> None:
    ...
    op.create_index("ix_pac_client_status", "pending_action_candidates", ["client_id", "status"])
    op.create_index(
        "ix_pac_client_originator", "pending_action_candidates", ["client_id", "originator_agent"]
    )
